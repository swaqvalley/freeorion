...
private:
    ...
    ResourceType    m_resource_type = INVALID_RESOURCE_TYPE;
    ...
    std::shared_ptr<GG::Label> m_production_label = nullptr;
    std::shared_ptr<GG::Label> m_allocation_label = nullptr;
    std::shared_ptr<GG::Label> m_import_export_label = nullptr;
